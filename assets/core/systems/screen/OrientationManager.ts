import { _decorator, view, EventTarget, log } from 'cc';
...
export class OrientationManager {
    ...
    private _checkOrientation(): void {
        ...
        const newOrientation =
            this._currentAspectRatio >= OrientationManager.LANDSCAPE_THRESHOLD
        ...
        if (isChanged) {
            ...
            log(
                `[Orientation] 方向變更: ${oldOrientation} -> ${newOrientation} (AR: ${this._currentAspectRatio.toFixed(2)})`,
            );
    ...
    public get isLandscape(): boolean {
        return this._currentOrientation === OrientationType.LANDSCAPE;
    }
